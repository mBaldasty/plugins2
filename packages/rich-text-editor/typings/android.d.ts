    ...
    export module richeditor {
      ...
      export module RichEditor {
        export class AfterInitialLoadListener {
           ...
           */
          public constructor(implementation: { onAfterInitialLoad(param0: boolean): void });
          public constructor();
        ...
        export class OnDecorationStateListener {
           ...
           */
          public constructor(implementation: { onStateChangeListener(param0: string, param1: java.util.List<jp.wasabeef.richeditor.RichEditor.Type>): void });
          public constructor();
        ...
        export class OnTextChangeListener {
           ...
           */
          public constructor(implementation: { onTextChange(param0: string): void });
          public constructor();
